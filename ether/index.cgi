...
my $json_dashboard =
	from_json(`curl -s "https://ethereum.miningpoolhub.com/index.php?page=api&action=getdashboarddata&api_key=$token&id=307328"`);
my $json_ticker =
	from_json(`curl -s https://api.coinmarketcap.com/v1/ticker/ethereum/`);
...
my @wallet_table = (
	{
		...
		uri => "https://ethereum.miningpoolhub.com/index.php?page=dashboard",
